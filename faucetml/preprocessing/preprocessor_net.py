...
from .identify_types import ENUM, FEATURE_TYPES
...
class Preprocessor(Module):
    ...
    def forward(
        ...
        # turn off clamping for now as for some feature types (e.g. DO_NOT_PREPROCESS,
        # CONTINUOUS, BOXCOX) it's possible to exceed this values.
        ...
        return cast(torch.Tensor, torch.cat(outputs, dim=1))
    ...
    def _sort_features_by_normalization(self):
        ...
        feature_starts = []
        assert isinstance(
            list(self.normalization_parameters.keys())[0], str
